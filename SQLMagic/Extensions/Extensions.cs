...
{
    /// <summary>
    /// This class contains a series of extension methods
    /// </summary>
    public static class Extensions
    {
        ...
        public static IEnumerable<T> Copy<T>(this IEnumerable<T> aItems)
        {
            ...
            // AddRange
            oItems.AddRange(aItems ?? new List<T>());
        ...
        {
            return new Queue<T>(aItems ?? new List<T>());
        }
        ...
        {
            return new ReadOnlyCollection<T>((aItems ?? Enumerable.Empty<T>()).ToList());
        }
